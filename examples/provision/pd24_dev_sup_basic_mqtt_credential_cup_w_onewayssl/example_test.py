...
def test_examples_hello_world(env, extra_data):
    app_name = 'dev_sup_basic_mqtt_credential_cup_w_onewayssl'
    dut = env.get_dut(app_name, 'examples/provision/pd24_dev_sup_basic_mqtt_credential_cup_w_onewayssl') #'examples/get-started/hello_world'
    dut.start_app()
