...
def test_examples_hello_world(env, extra_data):
    app_name = 'send_telemetry_and_client_attr'
    dut = env.get_dut(app_name, 'examples/tb_mqtt_client_helper/01_send_telemetry_and_client_attr') #'examples/get-started/hello_world'
    dut.start_app()
