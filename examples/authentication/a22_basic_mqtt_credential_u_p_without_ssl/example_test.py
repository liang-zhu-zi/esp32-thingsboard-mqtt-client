...
def test_examples_hello_world(env, extra_data):
    app_name = 'basic_mqtt_credential_u_p_without_ssl'
    dut = env.get_dut(app_name, 'examples/authentication/a22_basic_mqtt_credential_u_p_without_ssl') #'examples/get-started/hello_world'
    dut.start_app()
