...
def test_examples_hello_world(env, extra_data):
    app_name = 'dev_sup_x.509_ceritificate_w_twowayssl'
    dut = env.get_dut(app_name, 'examples/provision/pd31_dev_sup_x.509_ceritificate_w_twowayssl') #'examples/get-started/hello_world'
    dut.start_app()
