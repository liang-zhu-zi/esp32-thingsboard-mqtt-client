...
def test_examples_hello_world(env, extra_data):
    app_name = 'srv_gen_credentials_w_onewayssl'
    dut = env.get_dut(app_name, 'examples/provision/ps20_srv_gen_credentials_w_onewayssl') #'examples/get-started/hello_world'
    dut.start_app()
