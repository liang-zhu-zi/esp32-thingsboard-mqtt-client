...
- [Device provisioning - Devices supplies Basic MQTT Credentials, Client ID - Plain MQTT (without SSL)](#device-provisioning---devices-supplies-basic-mqtt-credentials-client-id---plain-mqtt-without-ssl)
