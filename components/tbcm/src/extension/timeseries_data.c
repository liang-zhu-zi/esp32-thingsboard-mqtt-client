...
static timeseriesdata_t *_timeseriesdata_create(tbcmh_handle_t client,
                                                  ...
                                                  tbcmh_tsdata_on_get_t on_get)
{
     ...
     // Create tsdata
     timeseriesdata_t *tsdata = _timeseriesdata_create(client, key, context, on_get);
     if (!tsdata) {
          // Give semaphore
...
tbc_err_t tbcmh_timeseriesdata_update(tbcmh_handle_t client,
