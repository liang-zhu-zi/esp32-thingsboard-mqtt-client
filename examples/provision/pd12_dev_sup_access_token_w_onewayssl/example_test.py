...
def test_examples_hello_world(env, extra_data):
    app_name = 'dev_sup_access_token_w_onewayssl'
    dut = env.get_dut(app_name, 'examples/provision/pd12_dev_sup_access_token_w_onewayssl') #'examples/get-started/hello_world'
    dut.start_app()
