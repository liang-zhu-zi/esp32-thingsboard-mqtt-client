...
def test_examples_hello_world(env, extra_data):
    app_name = 'dev_sup_basic_mqtt_credential_up_wo_ssl'
    dut = env.get_dut(app_name, 'examples/provision/pd22_dev_up_basic_mqtt_credential_cup_wo_ssl') #'examples/get-started/hello_world'
    dut.start_app()
