...
def test_examples_hello_world(env, extra_data):
    app_name = 'basic_mqtt_credential_c_without_ssl'
    dut = env.get_dut(app_name, 'examples/hsecurity_auth/s21_basic_mqtt_credential_c_without_ssl') #'examples/get-started/hello_world'
    dut.start_app()
