                            ...
                            int qos/*= 1*/, int retain/*= 0*/)
{
    ...
    TBC_CHECK_PTR_WITH_RETURN_VALUE(connect, ESP_FAIL);
    ...
    int msg_id = tbcm_gatewayconnect_publish(client->tbmqttclient, connect, qos, retain);
                            ...
                            int qos/*= 1*/, int retain/*= 0*/)
{
    ...
    int msg_id = tbcm_gatewaydisconnect_publish(client->tbmqttclient, telemetry, qos, retain);
                            ...
                            int qos/*= 1*/, int retain/*= 0*/)
{
    ...
    int msg_id = tbcm_gatewaytelemetry_publish(client->tbmqttclient, telemetry, qos, retain);
