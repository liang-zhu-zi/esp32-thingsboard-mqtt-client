...
// #define TBCM_OK    0   /*!< tbcm_err_t value indicating success (no error) */
// #define TBCM_FAIL -1   /*!< Generic tbcm_err_t code indicating failure */
...
// typedef int tbcm_err_t;

#define TBCM_MALLOC   malloc
#define TBCM_FREE     free
