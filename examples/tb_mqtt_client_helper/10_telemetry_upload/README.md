...
I (462) cpu_start: Project name:     telemetry_upload
...
I (563) TELEMETRY_UPLOAD: [APP] Startup..
I (573) TELEMETRY_UPLOAD: [APP] Free memory: 276368 bytes
I (573) TELEMETRY_UPLOAD: [APP] IDF version: v4.4.1-dirty
...
I (6163) TELEMETRY_UPLOAD: Init tbmch ...
I (6173) TELEMETRY_UPLOAD: Append telemetry: temprature...
I (6173) TELEMETRY_UPLOAD: Append telemetry: humidity...
I (6183) TELEMETRY_UPLOAD: Append client attribute: model...
I (6193) TELEMETRY_UPLOAD: Append client attribute: setpoint...
I (6203) TELEMETRY_UPLOAD: Connect tbmch ...
I (6203) tb_mqtt_client_helper: connecting to mqtt://192.168.0.187...
I (6213) TELEMETRY_UPLOAD: connect tbmch ...
...
I (7333) TELEMETRY_UPLOAD: Connected to thingsboard server!
I (10633) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (10633) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (10633) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (10643) tb_mqtt_client: [Telemetry][Tx] {"temprature":25,"humidity":26}
I (10653) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (10653) TELEMETRY_UPLOAD: Get model (a client attribute)
I (10663) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (10673) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (16193) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (16193) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (16193) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (16203) tb_mqtt_client: [Telemetry][Tx] {"temprature":25.5,"humidity":27}
I (16213) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (16223) tb_mqtt_client: MQTT_EVENT_PUBLISHED, msg_id=61674
I (16223) TELEMETRY_UPLOAD: Get model (a client attribute)
I (16223) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (16233) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (21753) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (21753) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (21753) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (21763) tb_mqtt_client: [Telemetry][Tx] {"temprature":26,"humidity":28}
I (21773) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (21783) tb_mqtt_client: MQTT_EVENT_PUBLISHED, msg_id=64837
I (21783) TELEMETRY_UPLOAD: Get model (a client attribute)
I (21783) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (21793) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (27313) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (27313) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (27313) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (27323) tb_mqtt_client: [Telemetry][Tx] {"temprature":26.5,"humidity":29}
I (27333) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (27333) TELEMETRY_UPLOAD: Get model (a client attribute)
I (27343) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (27343) tb_mqtt_client: MQTT_EVENT_PUBLISHED, msg_id=24466
I (27353) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (32873) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (32873) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (32873) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (32883) tb_mqtt_client: [Telemetry][Tx] {"temprature":27,"humidity":30}
I (32893) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (32893) TELEMETRY_UPLOAD: Get model (a client attribute)
I (32903) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (32903) tb_mqtt_client: MQTT_EVENT_PUBLISHED, msg_id=51643
I (32913) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (38333) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (38333) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (38333) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (38343) tb_mqtt_client: [Telemetry][Tx] {"temprature":27.5,"humidity":31}
I (38353) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (38363) tb_mqtt_client: MQTT_EVENT_PUBLISHED, msg_id=58923
I (38363) TELEMETRY_UPLOAD: Get model (a client attribute)
I (38363) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (38373) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (43893) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (43893) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (43893) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (43903) tb_mqtt_client: [Telemetry][Tx] {"temprature":28,"humidity":32}
I (43913) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (43913) tb_mqtt_client: MQTT_EVENT_PUBLISHED, msg_id=56451
I (43923) TELEMETRY_UPLOAD: Get model (a client attribute)
I (43923) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (43933) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (49453) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (49453) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (49453) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (49463) tb_mqtt_client: [Telemetry][Tx] {"temprature":27.5,"humidity":31}
I (49473) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (49483) tb_mqtt_client: MQTT_EVENT_PUBLISHED, msg_id=11894
I (49483) TELEMETRY_UPLOAD: Get model (a client attribute)
I (49483) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (49493) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (55013) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (55013) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (55013) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (55023) tb_mqtt_client: [Telemetry][Tx] {"temprature":27,"humidity":30}
I (55033) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (55033) TELEMETRY_UPLOAD: Get model (a client attribute)
I (55043) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (55043) tb_mqtt_client: MQTT_EVENT_PUBLISHED, msg_id=11883
I (55053) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (60573) TELEMETRY_UPLOAD: Send telemetry: temprature, humidity
I (60573) TELEMETRY_UPLOAD: Get temperature (a time-series data)
I (60573) TELEMETRY_UPLOAD: Get humidity (a time-series data)
I (60583) tb_mqtt_client: [Telemetry][Tx] {"temprature":26.5,"humidity":29}
I (60593) TELEMETRY_UPLOAD: Send client attributes: model, setpoint
I (60603) tb_mqtt_client: MQTT_EVENT_PUBLISHED, msg_id=16018
I (60603) TELEMETRY_UPLOAD: Get model (a client attribute)
I (60603) TELEMETRY_UPLOAD: Get local F/W version (a client attribute)
I (60613) TELEMETRY_UPLOAD: Get setpoint (a client attribute)
...
I (61633) TELEMETRY_UPLOAD: Disconnect tbmch ...
...
I (61843) TELEMETRY_UPLOAD: Destroy tbmch ...
