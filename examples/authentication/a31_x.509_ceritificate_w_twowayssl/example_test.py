...
def test_examples_hello_world(env, extra_data):
    app_name = 'x.509_ceritificate_w_twowayssl'
    dut = env.get_dut(app_name, 'examples/authentication/a31_x.509_ceritificate_w_twowayssl') #'examples/get-started/hello_world'
    dut.start_app()
