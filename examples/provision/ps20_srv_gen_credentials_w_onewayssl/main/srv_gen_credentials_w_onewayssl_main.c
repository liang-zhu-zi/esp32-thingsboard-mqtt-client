...
static const char *TAG = "SRV_GEN_CREDENTIALS_W_ONEWAYSSL";
...
static tbc_provison_config_t  _provision = 
            {
              .provisionType = TBC_PROVISION_TYPE_SERVER_GENERATES_CREDENTIALS, // Generates/Supplies credentials type. // Hardcode or device profile.
