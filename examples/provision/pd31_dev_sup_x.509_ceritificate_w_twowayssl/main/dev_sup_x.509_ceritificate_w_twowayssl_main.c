...
static const char *TAG = "DEV_SUP_X509_CERT_W_TWOWAYSSL_MAIN";
...
static tbc_provision_config_t  _provision = 
            {
              .provisionType = TBC_PROVISION_TYPE_DEVICE_SUPPLIES_X509_CREDENTIALS, // Generates/Supplies credentials type. // Hardcode or device profile.
